...
std::optional<bool> LIB_API toBool(const std::string& str);
std::optional<int> LIB_API toInt(const std::string& str);
std::optional<long long> LIB_API toLongLong(const std::string& str);
std::optional<double> LIB_API toDouble(const std::string& str, size_t decimal = DBL_DECIMAL);
